    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6 content text-right" id="ContentColumn">
                ...
                <form id="the_form" onsubmit="return forall();" method ="post" action = "DeleteRecords.php">

                <label for="">Employee ID to be Deleted</label>
                <input type="text" name="emp_idDelete" class="form-control" placeholder="" required>
                
                <label for="">Your ID</label>
                <input type="text" name="emp_id" class="form-control" placeholder="" required>
